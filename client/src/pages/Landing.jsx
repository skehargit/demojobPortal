...
const Landing = () => {
  ...
  return (
    <div className=''>
      ...
      <div>
      <div className=' flex items-center justify-center bg-gradient-to-r from-blue-500 to-blue-500'>
        <p className='text-2xl px-32 py-8 text-center text-white shadow-lg rounded-lg bg-black/40 backdrop-blur-sm'>
          Welcome to <span className='text-yellow-400 font-bold'>High Impact Talent</span>, your premier destination for connecting exceptional talent with high-impact roles. Whether you're a job seeker aiming to elevate your career or an employer searching for strategic professionals to drive your business forward, we are here to make it happen. <br /> Founded by seasoned experts from <span className='text-yellow-400'>Bain & Company</span> and the <span className='text-yellow-400'>Mahindra Group</span>, we specialize in strategic recruitment that aligns with your goals.
        </p>
      </div>
      <div className='h-scree py-6 flex items-center justify-center bg-gray-100'>
        <div className='flex flex-col max-w-[600px] gap-8 text-xl'>
          <div className='border border-[#1176DB] p-6 flex items-center gap-4 bg-white rounded-lg shadow-md transform transition duration-300 hover:scale-105 animate-fadeIn'>
            <FaUsers className='text-[#1176DB] text-3xl' />
